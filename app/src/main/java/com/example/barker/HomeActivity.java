...
import com.example.barker.Fragments.ChatsFragment;
import com.example.barker.Fragments.CirclesFragment;
import com.example.barker.Fragments.CreateFragment;
import com.example.barker.Fragments.HomeFragment;
import com.example.barker.Fragments.ProfileFragment;
    ...
    void settabs()
    {
        apptabs.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabUnselected(TabLayout.Tab tab) {
                tab.getIcon().setColorFilter(Color.parseColor("#865b51"), PorterDuff.Mode.SRC_IN);
            }
